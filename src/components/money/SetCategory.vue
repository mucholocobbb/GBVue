<template>
  <div class="money__setform">
    ...
    <div class="money__setform_itemblock" v-for="item in getCatList" :key="item.id">
      ...
      <button class="money__setform_itembtn" :id="item.id" @click="delCategory($event)">
        &#10006;
      </button>
    </div>
    <div class="money__setform_itemblock">
      <input
        class="money__setform_input"
        type="text"
      ...
      />
      <button
        class="money__setform_itembtn money__setform_itemaddbtn"
        @click="addCategory"
      >
        &#10010;
      </button>
